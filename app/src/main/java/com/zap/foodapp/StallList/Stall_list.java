...
public class Stall_list extends AppCompatActivity {


    private static String url = "http://13.59.128.132:8080/foodcourt/foodstall/list?";
        ...
        StringRequest string = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray array = jsonObj.getJSONArray("foodstalls");


                    for (int i = 0; i < array.length(); i++) {
                        JSONObject o = array.getJSONObject(i);
                        StallListItem list = new StallListItem(
                                o.getString("name"),
                                o.getString("stallNo"),
                                o.getString("phone"),
                                o.getString("rating"),
                                o.getString("email"),
                                o.getString("cuisines"),
                                o.getString("id")
                        );
                        listItems.add(list);
                    }

                    adapter = new StallAdapter(listItems, Stall_list.this);
