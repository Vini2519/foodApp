...
public class Navigation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FacebookSignupActivity facebookSignupActivity=new FacebookSignupActivity();
        facebookSignupActivity.finish();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.location) {
            Intent intent = new Intent(Navigation.this, SetLocation.class);
            startActivity(intent);
        } else if (id == R.id.order) {
            Intent intent = new Intent(Navigation.this, MyOrders.class);
            startActivity(intent);
        } else if (id == R.id.account) {
            Intent intent = new Intent(Navigation.this, MyAccount.class);
            startActivity(intent);
